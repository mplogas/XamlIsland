...
{
	Windows::UI::Xaml::DependencyProperty ColorPickerControl::_rProperty =
		Windows::UI::Xaml::DependencyProperty::Register(
			L"R",
			winrt::xaml_typename<double>(),
			winrt::xaml_typename<UWPControl::ColorPickerControl>(),
			Windows::UI::Xaml::PropertyMetadata{ winrt::box_value(0.0),
			Windows::UI::Xaml::PropertyChangedCallback{ &ColorPickerControl::OnRGBValueChanged } }
	);
	Windows::UI::Xaml::DependencyProperty ColorPickerControl::_gProperty =
		Windows::UI::Xaml::DependencyProperty::Register(
			L"G",
			winrt::xaml_typename<double>(),
			winrt::xaml_typename<UWPControl::ColorPickerControl>(),
	...
	Windows::UI::Xaml::DependencyProperty ColorPickerControl::_bProperty =
		Windows::UI::Xaml::DependencyProperty::Register(
			L"B",
			winrt::xaml_typename<double>(),
			winrt::xaml_typename<UWPControl::ColorPickerControl>(),
	...
	void ColorPickerControl::OnSizeChanged(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::SizeChangedEventArgs const& args)
	{
	...
	void ColorPickerControl::OnTapped(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::TappedRoutedEventArgs const& args)
	{
	...
	void ColorPickerControl::OnPositionManipulationStarted(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationStartedRoutedEventArgs const&)
	{
		_manipulationStartingPoint = _pickerPosition;
		_manipulationActive = true;
	}

	void ColorPickerControl::OnPositionManipulationDelta(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationDeltaRoutedEventArgs const& args)
	{
	...
	void ColorPickerControl::OnPositionManipulationCompleted(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationCompletedRoutedEventArgs const&)
	{
		_manipulationActive = false;
	}

	void ColorPickerControl::OnSizeManipulationStarted(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationStartedRoutedEventArgs const&)
	{
		_manipulationActive = true;
	...
	void ColorPickerControl::OnSizeManipulationDelta(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationDeltaRoutedEventArgs const& args)
	{
	...
	void ColorPickerControl::OnSizeManipulationCompleted(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Xaml::Input::ManipulationCompletedRoutedEventArgs const&)
	{
		_manipulationActive = false;
	}

	void winrt::UWPControl::implementation::ColorPickerControl::Marker_PointerEntered(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::Input::PointerRoutedEventArgs const&)
	{
	...
	void winrt::UWPControl::implementation::ColorPickerControl::Marker_PointerExited(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::Input::PointerRoutedEventArgs const&)
	{
		auto path = sender.try_as<Path>();
		if (!_manipulationActive && path) {
	...
	void ColorPickerControl::OnRGBValueChanged(Windows::UI::Xaml::DependencyObject const& d, Windows::UI::Xaml::DependencyPropertyChangedEventArgs const&)
	{
		using namespace DirectX;
		if (UWPControl::ColorPickerControl picker{ d.try_as<UWPControl::ColorPickerControl>() })
		{
	...
	Windows::UI::Xaml::DependencyProperty ColorPickerControl::RProperty()
	{
		return _rProperty;
	}

	Windows::UI::Xaml::DependencyProperty ColorPickerControl::GProperty()
	{
		return _gProperty;
	}

	Windows::UI::Xaml::DependencyProperty ColorPickerControl::BProperty()
	{
		return _bProperty;
	}

	winrt::Windows::UI::Xaml::Media::TranslateTransform ColorPickerControl::make_translate_transform(winrt::Windows::Foundation::Numerics::float2 translate)
	{
	...
	winrt::Windows::UI::Xaml::Media::CompositeTransform ColorPickerControl::make_translate_scale_transform(winrt::Windows::Foundation::Numerics::float2 translate, winrt::Windows::Foundation::Numerics::float2 scale)
	{
