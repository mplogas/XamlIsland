...
winrt::UWPControl::App hostApp{ nullptr };
winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource _desktopWindowXamlSource{ nullptr };
winrt::UWPControl::ColorPickerControl _colorPickerControl{ nullptr };
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   if (_desktopWindowXamlSource != nullptr)
   {
       ...
       _colorPickerControl = winrt::UWPControl::ColorPickerControl();
       _desktopWindowXamlSource.Content(_colorPickerControl);
   }
